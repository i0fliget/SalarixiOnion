...
class LineGraphicManager {
  ...
  private chartAverageLoad: any = null;
  ...
  public async addGraphicDataActiveBots(activeBotsQuantity: number): Promise<void> {
    ...
    if (this.chartActiveBots.data.labels && this.chartActiveBots.data.labels.length > 25) {
  ...
  public async addGraphicDataAverageLoad(averageLoad: number): Promise<void> {
    ...
    if (this.chartAverageLoad.data.labels && this.chartAverageLoad.data.labels.length > 25) {
