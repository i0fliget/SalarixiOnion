...
export class GhostPlugin {
  ...
  private reset(username: string, bot: Bot) {
    ...
    delete this.activePacketIgnore[username];
    delete this.originalWrite[username];
    delete this.packetBuffer[username];
  }
